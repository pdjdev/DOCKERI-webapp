...
전기 기술 문서 RAG (Retrieval-Augmented Generation) 시스템을 위한 FastAPI 백엔드 서버입니다.

## 📋 주요 기능

- **📄 문서 업로드**: PDF 및 Markdown 파일 지원
- **🧠 RAG 시스템**: LangChain + FAISS 벡터 검색
- **💬 실시간 채팅**: 스트리밍 응답 지원
- **🐍 코드 실행**: Python Code Interpreter 내장
- **📊 진행률 추적**: 백그라운드 문서 처리 상태 모니터링
